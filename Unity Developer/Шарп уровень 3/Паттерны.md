### Observable паттерн:
В кратце - у нас есть объект, на который подписаны объекты, и когда происходит какое-то изменение - объект передает их подписчикам.

![[Pasted image 20250121160552.png]]
...
public interface ISubject
{
	...
	void NotifyObserver(string eventMessage);
}
